...
points = [[carla.Transform(carla.Location(x=-66.2, y=-139.3, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=-180, roll=0)),
                   carla.Transform(carla.Location(x=-84.9, y=-126.5, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=92.0042, roll=0))],
                 [carla.Transform(carla.Location(x=-13.2, y=-135.1, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=0, roll=0)),
                   carla.Transform(carla.Location(x=5.9, y=-149.6, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=92.0042, roll=0))],
                  [carla.Transform(carla.Location(x=-19.4, y=135., z=1.8431),
                                   carla.Rotation(pitch=0, yaw=0, roll=0)),
                   carla.Transform(carla.Location(x=1.7, y=121.5, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=92.0042, roll=0))],
                 [carla.Transform(carla.Location(x=-63.6, y=131.7, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=180, roll=0)),
                   carla.Transform(carla.Location(x=-85.1, y=144.3, z=1.8431),
                                   carla.Rotation(pitch=0, yaw=92.0042, roll=0))]
                  ]
